...
function f(){
  if(lastVisible > 0 & lastVisible < 9){
    document.getElementById(lastVisible + "_text").style.display = "none"; 
    setDefaultSize();
  }
  ...
  function none(){
  $('img').each(function(){$(this).css('width','350px')});
  $('img').each(function(){$(this).css('height','350px')});
  setDefaultSize();
}
...
function altText(){
  ...
  document.getElementById(lastVisible + "_text").style.border = "" + document.getElementById("m").value  + "px solid green";
}
